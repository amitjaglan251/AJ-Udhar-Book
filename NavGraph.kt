            ...
            if (customer != null) {
                CustomerDetailsScreen(
                    ...
                    onSmsCustomer = {
                        ...
                        scopeLaunchSms(navController, customer!!.mobile, customer!!.name, currentBalance)
                    }
                )
            } else {
...
private fun scopeLaunchSms(
    ...
    val message = "AJ Udhar Book: $customerName, current balance ₹${String.format(Locale.US, "%.2f", balance)} hai."
    val intent = Intent(Intent.ACTION_SENDTO, Uri.parse("smsto:${mobile.trim()}"))
