        ...
        LazyColumn(
            ...
            item {
                Card(
                    ...
                    colors = CardDefaults.cardColors(CustomerBlue),
            ...
            item {
                DashboardCard(
                    ...
                    if (currentBalance > 0) UdharGreen else if (currentBalance < 0) PaymentRed else BalanceOrange,
                    "💳",
