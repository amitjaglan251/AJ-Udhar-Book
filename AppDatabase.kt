    ...
    companion object {
        ...
        private val MIGRATION_1_2 = object : Migration(1, 2) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                """.trimIndent())
                database.execSQL("""
                    INSERT INTO transactions (id, customerId, amount, type, note, timestamp)
                    SELECT id, customerId, amount, type, note, createdAt FROM transactions_old
                """.trimIndent())
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE customers ADD COLUMN sharedLedgerId TEXT NOT NULL DEFAULT ''")
                database.execSQL("ALTER TABLE transactions ADD COLUMN syncKey TEXT NOT NULL DEFAULT ''")
            }
        }
